...
export default class Xyhschd20 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            <p>1.新注册玩家完成手机以及银行卡绑定后前往当前活动界面进行申请，申请开放时间为每天00:00-23:59:59。所有未申请的玩家无法领取活动彩金。</p>
                            <p>2.平台中的新用户活动只能参加一个。</p>
                            <p>3.玩家必须充值成功未下注时进行领取，需满足首充金额一倍流水+赠送彩金的{this.state.info.flow_rate}倍流水才能申请兑换。</p>
                            <p>4.游戏规则：仅参加以下游戏《财神到》《水果机》《捕鱼·海王》《捕鱼·聚宝盆》《多福多财》《疯狂旋涡》《PG电子游戏》《PG2电子游戏》《CQ9电子游戏》《JDB电子游戏》《AG电子游戏》《PT电子游戏》《MG电子游戏》《QT电子游戏》《PP电子游戏》。</p>
