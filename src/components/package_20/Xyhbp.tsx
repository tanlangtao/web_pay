...
export default class Xyhbp20 extends React.Component<Props,State>{
    state = {
        showGuize:false,
        info:{
            flow_rate:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhbp20" >
                <div className="bg"></div>
                <div className = "group">
                    <div className ="line">
                        <div className ="li1 flexBox title" >首充金额</div>
                        <div className ="li2 flexBox title" >包赔金额</div>
                        <div className ="li3 flexBox title" >最高兑换金额</div>
                        <div className ="li4 flexBox title" >限制最高注</div>
                    </div>
                    {
                        rangeLine()
                    }
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            <p>1.新注册玩家完成手机以及银行卡绑定后前往当前活动界面进行申请，申请开放时间为每天{gHandler.transitionTime(this.state.info.start)}-{gHandler.transitionTime(this.state.info.end)}。所有未申请的玩家无法领取活动彩金。</p>
                            ...
                            <p>5.赢金达到规定金额不兑换视为放弃包赔资格（输完不赔付)，首次提交兑换时超出首充金额对应的最高兑换金额部分会自动扣除。</p>
