...
export default class Lyhsc20 extends React.Component<Props,State>{
    state = {
        showGuize:false,
        info:{
            range:[
    ...
    render (){
        ...
        return (
            <div className ="Lyhsc20" >
                <div className ="bg"></div>
                <div className = "group">
                    <div className="line">
                        <div className ="li1 flexBox" style={{fontWeight:"bold"}} >充值金额</div>
                        <div className ="li2 flexBox" style={{fontWeight:"bold"}}>赠送彩金</div>
                        <div className ="li3 flexBox" style={{fontWeight:"bold"}}>流水要求</div>
                        <div className ="li4 flexBox" style={{fontWeight:"bold"}}></div>
                    </div>
                    {
                        rangeLine()
                    }
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            ...
                            <p>2.游戏规则：仅参加以下游戏《财神到》《水果机》《捕鱼·海王》《捕鱼·聚宝盆》《多福多财》《疯狂旋涡》《PG电子游戏》《PG2电子游戏》《CQ9电子游戏》《JDB电子游戏》《AG电子游戏》《PT电子游戏》《MG电子游戏》《QT电子游戏》《PP电子游戏》。</p>
