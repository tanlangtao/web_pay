...
export default class Xyhschd12 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhschd12" >
                <div className = "group">
                    <div className="line"> 
                        <div className="li1 flexBox" style={{color:"#6F6BDA"}}>充值金额</div>
                        <div className="li2 flexBox" style={{color:"#6F6BDA"}}>赠送彩金</div>
                ...
                <div className = "rule">
                    ...
                    <p>4. 游戏规则：仅参加以下游戏《财神到》《水果机》《多福多财》《疯狂旋涡》《捕鱼·聚宝盆》《捕鱼·海王》。</p>
                    <p>5. 每一个账号(同一IP，同一设备，同一姓名视为一个账号）仅限领取一次。</p>
                    <p>6. 平台拥有最终解释权，严禁一切恶意行为，出现违规情况，一律封号处理；</p>
                    <p>同时平台有权根据实际情况，随时调整活动内容。</p>
                </div>
            </div>
        )
    }
