...
export default class Xyhbp10 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
            ...
            <div className ="Xyhbp" style={{
                ...
                <div className = "group">
                    ...
                    <div className ="applyBtnLabel">
                        <div className="flexBox">活动开放时间等待官方通知</div>
                        {/* <div className="flexBox">{gHandler.transitionTime(this.state.info.start)}-{gHandler.transitionTime(this.state.info.end)}</div> */}
                    </div>
                </div>
                <div className = "rule">
                    <p>1. 新用户注册好账号，绑定手机号码与银行卡进行申请，名额有限，先到先得，<span style={{color:"#ff0000"}}>活动开放时间等待官方通知</span></p>
                    <p>2. 平台中的新玩家活动只能参加其中一个，申请后即视为参加此活动。</p>
                    <p>3. 参加活动的玩家只能进行<span style={{color:"#F3DC5B"}}>《财神到》《捕鱼·海王》《捕鱼·聚宝盆》《水果机》《AGA电子游戏》</span>游戏，进行其他游戏视为放弃活动。当日23:59:59未进行领取视为自动放弃。</p>
                    <p>4. 在规定游戏中投注对应档位最高单注金额内，亏损至余额低于10金币时前往app端《专线包赔活动》界面领取。</p>
                    <p>5. 赢金到规定金额内不兑换视为放弃包赔资格（输完不赔付）。</p>
