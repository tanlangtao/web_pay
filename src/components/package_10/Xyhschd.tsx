...
export default class Xyhschd10 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhschd" style={{
                ...
                <div className = "rule">
                    <p>1. 新注册玩家完成手机以及银行卡绑定后前往当前活动进行申请。<span style={{color:"#FF000"}}>所有未进行申请的玩家无法领取活动彩金</span></p>
                    <p>2. 平台中的新用户活动只能参加一个。</p>
                    <p>3. 玩家必须充值成功未下注时进行领取，需满足首充金额一倍流水+赠送彩金的8倍流水才能申请兑换。</p>
                    <p>4. 游戏规则：仅参加以下游戏<span style={{color:'#F3DC5B'}}>《财神到》《水果机》《捕鱼·海王》《捕鱼·聚宝盆》《AGA电子》《CQ9电子游戏》《PT电子游戏》《JDB电子游戏》《PG电子游戏》《AG电子游戏》</span></p>
