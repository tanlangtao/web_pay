...
export default class Lyhsc10 extends React.Component<Props,State>{
    state = {
        info:{
            range:[
                {
        ...
        return (
            <div className ="Lyhsc10" style={{
                ...
                <div className = "rule">
                    ...
                    <p>2. 游戏规则：仅参加以下游戏<span style={{color:"#F3DC5B"}}>《财神到》《水果机》《捕鱼·海王》《捕鱼·聚宝盆》《AGA电子游戏》《CQ9电子游戏》《AG电子游戏》《PT电子游戏》《JDP电子游戏》《PG电子游戏》</span></p>
                    <p>3. 单日充值金额累加统计，单日累计充值金额达到指定档位，即可领取活动规定的相应金币。</p>
                    <p>4. 每日23:59:59，活动计算的当日充值金额累加归零。</p>
                    <p>5. 每一个账户（同一IP，同一设备，同一姓名视为一个账号）每天只能领取一次。</p>
