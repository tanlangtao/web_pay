...
export default class CdxQiQu extends React.Component<Props,State>{
    state = {
        info:{
            win:0,
            range:[
    ...
    private async  Axios_game_HandleQiQuWin(){
        ...
        return (
            <div className ="CdxQiQu" >
                <div className = "group">
                    ...
                    <div className ="label1">奇趣分分彩</div>
                ...
                <div className = "rule">
                    ...
                    <p>2. 活动限制：<span style={{color:"#E3FD00"}}>仅限分分彩猜大小-奇趣分分彩房间</span></p>
