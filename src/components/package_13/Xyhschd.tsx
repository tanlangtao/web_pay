...
export default class Xyhschd13 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhschd13" >
                <div className = "group">
                    <div className="line title"> 
                        <div className="li1 flexBox" style={{color:"rgb(243,221,143)"}}>首充金额</div>
                        <div className="li2 flexBox" style={{color:"rgb(243,221,143)"}}>活动彩金</div>
                        <div className="li3 flexBox" style={{color:"rgb(243,221,143)"}}>提现流水要求</div>
                    </div>
                    {
                        rangeLine()
                    }
                ...
                <div className = "rule">
                    ...
                    <p>4. 游戏规则：仅参加以下游戏《AG电子游戏》《PT电子游戏》《JDB电子游戏》《CQ9电子游戏》《PG电子游戏》《PG2电子游戏》《PP电子游戏》《MG电子游戏》《QT电子游戏》《财神到》《水果机》《多福多财》《海王捕鱼》《聚宝盆捕鱼》《疯狂漩涡》。</p>
