...
export default class Xyhbp13 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            ...
                            <p>3. 参加活动的玩家只能进行《AG电子游戏》《PT电子游戏》《JDB电子游戏》《CQ9电子游戏》《PG电子游戏》《PG2电子游戏》《PP电子游戏》《MG电子游戏》《QT电子游戏》《财神到》《水果机》《多福多财》《海王捕鱼》《聚宝盆捕鱼》《疯狂漩涡》指定游戏，进行其他游戏视为放弃活动。</p>
