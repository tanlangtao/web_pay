...
export default class Lyhsc13 extends React.Component<Props,State>{
    state = {
        info:{
            range:[
                {
        ...
        return (
            <div className ="Lyhsc13" >
                ...
                <div className = "rule">
                    ...
                    <p>2.游戏规则：仅参加以下游戏《AG电子游戏》《PT电子游戏》《JDB电子游戏》《CQ9电子游戏》《PG电子游戏》《PG2电子游戏》《PP电子游戏》《MG电子游戏》《QT电子游戏》《财神到》《水果机》《多福多财》《海王捕鱼》《聚宝盆捕鱼》《疯狂漩涡》。</p>
