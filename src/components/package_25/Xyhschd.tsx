...
export default class Xyhschd25 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
        ...
        return (
            <div className ="Xyhschd25" >
                ...
                <div className = "rule">
                    ...
                    <p>4. 游戏规则：仅参加以下游戏《财神到》《水果机》《海王捕鱼》《聚宝盆捕鱼》《多福多财》《疯狂漩涡》《CQ9游戏》《PT游戏》《JDB游戏》《PG游戏》《PG2游戏》《AG游戏》《PP游戏》《MG游戏》《QT游戏》。</p>
