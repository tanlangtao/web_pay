...
export default class DailySign25 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            range:[
                        ...
                        <div className={`icon icon${index+1}`}>
                            {
                                flagData.check_receive && flagData.day===index ?
                                    (flagData.is_received === 0 ?<div onClick={this.onClick}><div className="waitToCheck"></div></div>:<div className="yilingqu"></div>):
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            ...
                            <p>3. 活跃用户定义：玩家单日有效投注满200即可（沙巴体育，三昇体育，真人视讯，彩票游戏不参与统计）。</p>
