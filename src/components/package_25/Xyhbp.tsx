...
export default class Xyhbp25 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhbp25" >
                <div className = "group">
                    <div className ="line">
                        <div className ="li1 flexBox" >首充金额</div>
                        <div className ="li2 flexBox" >包赔金额</div>
                        <div className ="li3 flexBox" >最高兑换金额</div>
                        <div className ="li4 flexBox" >限制最高注</div>
                    </div>
                    {
                        rangeLine()
                    }
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            ...
                            <p>3. 参加活动的玩家只能进行《财神到》《聚宝盆捕鱼》《海王捕鱼》《水果机》《多福多财》游戏，进行其他游戏视为放弃活动。</p>
