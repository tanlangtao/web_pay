...
export default class Lyhsc15 extends React.Component<Props,State>{
    state = {
        info:{
            range:[
                {
            ...
            <div className ="Lyhsc15" >
                ...
                <div className = "group">
                    <div className="line">
                        ...
                        <div className ="li4 flexBox" >状态</div>
                    </div>
                    {
                        rangeLine()
                    }
                ...
                <div className = "rule">
                    ...
                    <p>2. 游戏规则：仅参加以下游戏《财神到》《水果机》《捕鱼·海王》《捕鱼·聚宝盆》《多福多财》《疯狂旋涡》《CQ9电子游戏》《PT电子游戏》《JDB电子游戏》《PG电子游戏》《AG电子游戏》《PG2电子游戏》《MG电子游戏》《QT电子游戏》。</p>
