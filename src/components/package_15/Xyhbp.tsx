...
export default class Xyhbp15 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
    ...
    render (){
        ...
        return (
            <div className ="Xyhbp15" >
                ...
                <div className = "rule">
                    <p>1. 绑定手机和银行卡即可申请参加， 所有未进行申请的玩家无法领取活动彩金。</p>
                    <p>2. 参加活动的玩家只能进行《财神到》《捕鱼·海王》《捕鱼·聚宝盆》《水果机》指定游戏，进行其他游戏视为放弃活动。</p>
                    <p>3. 在规定游戏中投注对应档位最高单注金额内，亏损至余额低于10金币时即可领取活动彩金，当日23:59:59未进行领取视为自动放弃</p>
                    <p>4. 赢金到规定金额不兑换视为放弃包赔资格（输完不赔付）。</p>
