    ...
    render (){
        ...
        return (
            <div className ="Jcbshl" >
                ...
                <div className = "rule">
                    <p>1. 玩家在分分彩猜大小河内分分彩游戏房间中游戏所产生的流水才计算到排行榜中,在其他游戏中产生的流水不计算其中。</p>
                    <p>2. 活动时间:每日11:00am至次日凌晨02:00， 每天共发放15轮奖励。</p>
                    <p>3. 所有在分分彩猜大小河内分分彩中的玩家总流水达到1万，奖池将增加20金币，每小时按照玩家当前所贡献的流水进行排名，前10名按名次瓜分当前奖池总奖金，每小时排行榜中的流水和奖池将清零并结算一次，重新开始计算。</p>
                    <p>4. 活动奖励:每小时整点结算后, 系统自动发放。第一名:25%, 第二名:20%, 第三名, 15% 第四名:9%, 第五名:6%, 第六名至第十名:5%。</p>
                </div>
            </div>
        )
    }
