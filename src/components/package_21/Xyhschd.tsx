...
export default class Xyhschd21 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            start:0,
                ...
                <div className="guizeBtn" onClick={this.guizeClick}>
                    {
                        this.state.showGuize ?<div className="guizeMask">
                            ...
                            <p>3. 玩家必须充值成功未下注时进行领取，需满足首充金额1倍流水+赠送彩金的{this.state.info.flow_rate}倍流水才能申请兑换。</p>
                            <p>4. 游戏规则：仅参加以下游戏《财神到》《水果机》《捕鱼 ‧ 海王》《捕鱼 ‧ 聚宝盆》《多福多财》《疯狂漩涡》《CQ9电子游戏》《PT电子游戏》《JDB电子游戏》《PG电子游戏》《PG2电子游戏》《AG电子游戏》。</p>
                            <p>5. 每日23:59:59，活动计算的当日充值金额累加归零。</p>
                            <p>6. 每一个账号（同一ip，同一设备，同一姓名视为一个账号）每天只能领取一次。</p>
