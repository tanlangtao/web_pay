...
export default class DailySign21 extends React.Component<Props,State>{
    state = {
        info:{
            flow_rate:0,
            range:[
    ...
    render (){
        ...
        let rangeLine = ()=>{
            return  this.state.info.range.map((e:any,index:number) => {
                if(index<7){
                    return <div className ={`li li${index+1} flexBox`}  key={index} onClick={this.tipClick}>
                        <div></div>
                        <div className ="icon">
                            {
