...
export default class Bytghl8 extends React.Component<Props,State>{
    state = {
        info:{
            start:0,
            end:0,
    ...
    render (){
        ...
        return (
            <div className ="Bytghl8" >
                <div className = "group">
                    <div className="line">
                        <div className ="li1 flexBox" style={{color:"rgb(121,126,179)"}}>活动对象</div>
                        <div className ="li2 flexBox" style={{color:"rgb(121,126,179)"}}>关卡</div>
                        <div className ="li3 flexBox" style={{color:"rgb(121,126,179)"}}>有效投注</div>
                        <div className ="li4 flexBox" style={{color:"rgb(121,126,179)"}}>活动彩金</div>
                        <div className ="li5 flexBox" style={{color:"rgb(121,126,179)"}}>流水要求</div>
                    </div>
                    {
                        rangeLine()
                    }
